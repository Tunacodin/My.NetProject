...
namespace Entities.Concrete // Entities dosyası -> Concrete klasörü 
{
    ...
    public class Product:IEntity // Bu sayede Product bir varlıktır dedik ve veritabanındaki bir tabloya karşılık gelecek
    {
        //Ürün Id
